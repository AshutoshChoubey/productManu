    ...
    $viewData['pageTitle'] = 'Employee Dretail'; 
    	...
    	else 
    	{
            if(((!isset($id) && $id == null) && $request->isMethod('post') ))
            {
                ...
                $allInputValueManage['created_at']=Auth::user()->id;
                if($allInputValueManage->save()){
                    $request->session()->flash('message.level', 'success');
                    $request->session()->flash('message.content', 'Employee Dretail Saved Successfully!');
    ...
    public function update(Request $request, $id = null)
    {
        ...
        $getFormAutoFillup=array();
            ...
            if(((!isset($id) && $id == null) && $request->isMethod('post') ))
            {
                ...
                $allInputValueForUpdate['created_at']=Auth::user()->id;
